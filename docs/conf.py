...
project = 'Pylons Project Documentation Style Guide'
thisyear = datetime.datetime.now().year
copyright = '2018-%s, Agendaless Consulting' % thisyear
author = 'Steve Piercy'
...
htmlhelp_basename = 'PylonsProjectDocumentationStyleGuidedoc'
...
man_pages = [
    (master_doc, 'pylonsprojectdocumentationstyleguide', 'Pylons Project Documentation Style Guide Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PylonsProjectDocumentationStyleGuide', 'Pylons Project Documentation Style Guide Documentation',
     author, 'PylonsProjectDocumentationStyleGuide', 'One line description of project.',
     'Miscellaneous'),
]
